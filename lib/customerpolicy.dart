...
class CustomerPolicy extends StatefulWidget {
  ...
  const CustomerPolicy({Key? key}) : super(key: key);

  @override
  State<CustomerPolicy> createState() => _CustomerPolicyState();
}
            ...
            child: SizedBox(
              ...
              child: Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text('CUSTOMER REVIEW POLICY:',style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500),),
